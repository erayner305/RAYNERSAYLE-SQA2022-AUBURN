...
def getPythonParseObject( pyFile ):
    ...
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getPythonParseObject', str(full_tree)))
    return full_tree 
...
#     print("import list: ", import_list)
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getImport', str(pyTree)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getImport', str(import_list)))
    return import_list 
...
def getFunctionDetailsForClaases(pyTree):
    ...
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getFunctionDetailsForClasses', str(pyTree)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getFunctionDetailsForClasses', str(func_list)))
    return func_list
            ...
            if isinstance(node_, ast.Assign):
                ...
                if isinstance(value, ast.Call):
                    ...
                    if( isinstance(funcName, ast.Name ) ): 
                    	...
                    	func_list.append(func_name )  
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getFunctionAssignments', str(class_body)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getFunctionAssignments', str(func_list)))
    return func_list
...
def checkForLibraryImport(pyTree):
    ...
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'checkForLibraryImport', str(pyTree)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'checkForLibraryImport', str(import_list)))
...
def checkAlgoNames(func_list):
    ...
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'checkAlgoNames', str(func_list)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'checkAlgoNames', str(algo_list)))
    return algo_list
...
#     print("algo list  ", algo_list)  
    logO = getLoggerObj()
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getClassificationAlgoNames', str(pyTree)))
    logO.debug('{}*{}*{}'.format('py_parser.py', 'getClassificationAlgoNames', str(algo_list)))
    return algo_list
